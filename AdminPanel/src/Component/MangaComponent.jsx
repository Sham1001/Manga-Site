...
const MangaComponent = ({ name, chapters, coverImg, date}) => {
                    ...
                    <div className="flex justify-between">
                        <div>
                            <p className="text-gray-900 font-semibold text-sm">
                                Chapter {chapters?chapters:10}
                            </p>
                            <p className="text-gray-500 text-sm">
                                Chapter {chapters? chapters - 1:9}
                            </p>
                        </div>

                        <div className="text-right text-gray-400 text-xs">
                            <p>{date? date: "26/08/2025"}</p>
                            <p>{date? date: "19/08/2025"}</p>
                        </div>
                    </div>
